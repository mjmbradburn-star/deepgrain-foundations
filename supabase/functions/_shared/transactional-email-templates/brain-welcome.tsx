      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Section style={contentSection}>
            <Text style={eyebrow}>
              {isResend ? "Brain link · resend" : "The Brain"}
            </Text>
            <Heading style={h1}>
              {isResend
                ? "Here\u2019s your Brain link again."
            ...
            <Text style={text}>
              ...
              section near the top is the fastest route in. From there you can
              drop into Foundations, Skills, Systems, or the Human Layer
              depending on what you need this week.
            </Text>
