    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={contentSection}>
          ...
          <Text style={footer}>
            This code expires shortly. If you didn&apos;t request it, you
...
const codeWrap = { backgroundColor: COLOR_CREAM, borderRadius: '12px', padding: '20px 28px', margin: '8px 0 28px', textAlign: 'center' as const }
const codeStyle = { fontFamily: '"SFMono-Regular", Consolas, "Liberation Mono", Menlo, monospace', fontSize: '28px', fontWeight: 700, letterSpacing: '0.18em', color: COLOR_GREEN, margin: 0 }
