...
export const CATEGORIES: Category[] = [
  ...
  { slug: "sector-lenses", name: "Sector Lenses", description: "AI enablement applied to specific industries.", track: "deepgrain", metaDescription: "AI enablement applied to specific industries: climate ventures, transit and mobility, financial data, and defence tech." },
