export const frontmatter = {
  ...
  description: "How to diagnose an organisation in 30 days: two-thirds listening, one-third synthesis, and zero recommendations until you have earned the right to make them.",
