export const frontmatter = {
  ...
  description: "How to diagnose an organisation in 30 days: two-thirds listening, one-third synthesis, nothing recommended until earned. The People and ops leader's first read.",
  keywords: ["how to diagnose an organisation", "30 day organisational diagnostic", "organisational diagnosis", "operating diagnostic", "reading an organisation", "consulting diagnostic process"],
  readTime: "11 min",
...
export const faqs = [
  ...
  {
    question: "Who should you interview in an organisational assessment?",
    answer: "The load-bearing people, not just the senior people, and they are rarely the same set. Find them by asking everyone the same question: if you were stuck and it actually mattered, who would you go to? Three or four names keep coming back regardless of level or function. Those people live the operating reality that leadership only has a story about.",
  },
  {
    question: "Why is it a mistake to recommend changes in the first week?",
    answer: "Because a week-one recommendation spends the trust the rest of the engagement runs on, and you do not get it back inside the same contract. Either you solved in five days what a whole leadership team could not, which nobody believes, or you sold them a template with their names inserted. After that, every finding gets read through the filter of whether it is genuinely about them or the template again.",
  },
];

<TLDR>
- A 30-day diagnostic is the permission to do the work, not the work itself.
- Split it two-thirds listening, one-third synthesis, and zero recommending until both are finished.
- Talk to the load-bearing people, not just the senior people. They are rarely the same set.
- Diagnose the operating reality, what happens on Tuesday at four o'clock, not the operating story leadership rehearses.
- The output is a shared diagnosis the leadership team can repeat in a room you are not in, not a deck of findings.
</TLDR>
...
This is the Read in [Read, Craft, Scale](/intelligence/read-craft-scale-the-deepgrain-method). Get the reading wrong and everything downstream is built on a guess. Get it right and the craft that follows feels less like your idea and more like the obvious next step from a diagnosis the room already agrees with.
...
<ProcessFlow
  stages={[
    { label: "Listen", body: "Interviews, shadowing and document review. Build a picture of what actually happens, not what the strategy deck says happens.", meta: "Days 1-20" },
    { label: "Synthesise", body: "Find the two or three things that make forty scattered observations click into one shape. This is harder than it looks and it is where the value is.", meta: "Days 21-28" },
    { label: "Land", body: "Hand back a shared diagnosis the leadership team can defend in their own words. Not a slide deck of findings.", meta: "Days 29-30" },
  ]}
/>
...
<ComparePanel
  a={{ heading: "The operating story", items: [
  ...
  b={{ heading: "The operating reality", items: [
  ...
  caption="Your job for the first twenty days is to build a picture of the reality column, not the story column."
/>
...
Nobody had questioned it, because questioning it was nobody's job. That licence never showed up in a leadership interview. It surfaced on a Tuesday, from someone three levels down, because I asked what actually gets used rather than what is on the list.
</FieldNote>
...
Everything after that point gets read through a filter of "is this genuinely about us, or is this the template again." You have lost the one asset that makes the eventual recommendations land: the sense that you earned the right to make them. This is the same failure mode that sinks so many change programmes, and it is one of the reasons [most change programmes fail](/intelligence/why-most-change-programmes-fail) before the first intervention is even chosen. The fix arrived before the understanding did.
...
<DecisionFilter
  title="Before you turn synthesis into recommendations, the diagnosis has to clear these"
  criteria={[
    { test: "Has something genuinely surprised you since week one?", fail: "Everything you found confirmed the hypothesis you carried in from the sales call" },
    { test: "Does the diagnosis name where the story and the reality diverge, with a specific example?", fail: "It restates the strategy deck back to leadership in tidier language" },
    { test: "Can a load-bearing person you did not interview recognise the problem when you describe it?", fail: "Only the people who were in the room nod along" },
    { test: "Would the ops director repeat it in their own words in a meeting you are not in?", fail: "It only holds together while your slides are on the screen" },
  ]}
  verdict="If it survives only with you in the room narrating it, you built something persuasive, not something true."
/>
...
- Build your own interview list around the load-bearing people, found by asking everyone who they go to when stuck.
- Chase the specific Tuesday, not the policy answer. Ask people to walk you through the last real piece of work, click by click.
- A week-one recommendation spends the trust the whole engagement runs on, and you do not get it back inside the same contract.
- The diagnosis is durable only when the people inside the company can repeat it, in their own words, in a room you are not in.
</KeyTakeaways>
