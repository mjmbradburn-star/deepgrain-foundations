export const frontmatter = {
  title: "AI enablement for transit and mobility companies",
  slug: "operating-consultancy-for-transit-and-mobility",
  category: "sector-lenses",
  description: "AI enablement for transit and mobility: hardware, software and public trust run on three clocks. How to add AI and team skills without forcing a fit.",
  keywords: ["AI enablement for transit and mobility companies", "operating consultancy for transit and mobility", "transit operating model", "mobility operating consultancy", "transit digital transformation", "public transport operations", "transit software governance"],
  readTime: "12 min",
