...
This piece walks through the practical structure: foundational prep, governance, guardrails, and the shadow-AI question that most policies pretend does not exist.
...
The policy is one piece of the wider [AI enablement operating model](/intelligence/ai-enablement-operating-model). It sits underneath the [diagnostic](/intelligence/diagnosing-ai-readiness-in-people-ops), gets used inside the [AI workspace](/intelligence/setting-up-your-ai-workspace), and constrains the [production agents](/intelligence/production-agents-for-people-ops) the team eventually builds.

A good AI policy in a People function does one job: it makes the safe thing the easy thing. Everything else, the rituals, the guardrails, the audits, the escalation paths, exists to support that. Get the policy right, and adoption gets faster, not slower. Get it wrong, and adoption just goes underground.
