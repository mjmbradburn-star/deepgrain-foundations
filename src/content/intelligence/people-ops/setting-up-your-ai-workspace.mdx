...
If you are not sure where your function actually stands before you build, the [Readiness Assessment](/readiness) scores you across the four capability layers in about ten minutes, and it tends to make the case for starting here obvious. For the wider map of how workspace, skills and agents fit together, the [People Ops AI guide](/intelligence/pillar/people-ops-ai) holds the full arc.
