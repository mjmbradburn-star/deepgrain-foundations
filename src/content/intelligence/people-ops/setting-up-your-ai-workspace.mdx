export const frontmatter = {
  ...
  track: "people-ops",
  description: "Most People teams treat AI like a search bar. The ones getting real leverage treat it like a workspace — projects, context, instructions, shared memory. Here is how to set yours up.",
  keywords: ["AI workspace", "Claude Projects", "ChatGPT custom instructions", "People Ops AI setup", "AI for HR"],
  readTime: "12 min",
