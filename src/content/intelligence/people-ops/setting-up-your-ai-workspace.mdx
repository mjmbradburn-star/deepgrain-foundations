export const frontmatter = {
  ...
  track: "people-ops",
  description: "Set up an AI workspace with standing instructions, workstream projects, approved references and review rules. The same pattern works in every function.",
  keywords: ["AI workspace setup", "AI workspace for teams", "Claude Projects", "ChatGPT custom instructions", "Copilot workspace", "AI workspace for People Ops"],
  readTime: "11 min",
...
An AI workspace is the standing context, approved reference material and review rules that turn a generic model into a useful colleague. The same pattern works in Finance, Sales, Marketing, Operations, Customer and People: one brief, one project per recurring workstream, and controlled sources the model can trust.
