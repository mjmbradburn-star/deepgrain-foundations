export const frontmatter = {
  ...
  keywords: ["production agents for People Ops", "AI agents in HR", "why AI agents fail in production", "n8n HR automation", "AI agent context stack", "how to build an AI agent in People Ops"],
  readTime: "12 min",
...
export const faqs = [
  ...
  },
  {
    ...
    answer: "No. A workflow tool like n8n connects your existing systems and runs the AI steps inside auditable pipelines, at around £20 per builder seat per month, SOC 2 and ISO 27001 compliant, and self-hostable. Two trained internal builders on the People team can ship more real capability than the tenth specialist HR app ever will. The skill you need is workflow thinking, not software engineering.",
  },
  {
