export const frontmatter = {
  ...
  description: "Scale without breaking the grain: diagnose structural strain, protect the rituals that hold, and repair the operating system before growth compounds the damage.",
