export const frontmatter = {
  ...
  description: "Scaling without breaking the grain, for People and ops leaders: read the strain, protect the rituals that hold, repair the system before growth compounds it.",
