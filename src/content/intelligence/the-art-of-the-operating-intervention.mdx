export const frontmatter = {
  ...
  description: "People and ops leaders reach for scale because scale feels serious. The best intervention is the smallest change that moves the system. How to size it.",
  keywords: [
