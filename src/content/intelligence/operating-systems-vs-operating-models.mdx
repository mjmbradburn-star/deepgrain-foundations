export const frontmatter = {
  ...
  description: "Operating system vs operating model: one is a slide you present, one is what runs when nobody is looking. The difference, and why you read the system first.",
  keywords: ["operating system vs operating model", "operating model", "operating system", "AI operating model", "organisational design", "how to read an operating system"],
  readTime: "10 min",
