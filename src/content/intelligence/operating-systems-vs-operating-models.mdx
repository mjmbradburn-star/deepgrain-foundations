export const frontmatter = {
  ...
  description: "Operating system vs operating model: the practical difference, how to diagnose each, and why changing the deck rarely changes how work actually runs.",
