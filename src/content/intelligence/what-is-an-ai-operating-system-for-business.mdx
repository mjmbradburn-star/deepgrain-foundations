export const frontmatter = {
  ...
  description:
    "A plain-language guide for business leaders moving from scattered AI tools to an integrated AI operating system, using Deepgrain's Read, Craft, Scale method.",
  keywords: [
