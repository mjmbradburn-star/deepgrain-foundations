export const frontmatter = {
  ...
  description: "In financial data the pipeline is the product. A financial data operating model puts engineering, governance and trust in that order, not the dashboard first.",
  keywords: [
