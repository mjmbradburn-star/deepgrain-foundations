export const frontmatter = {
  ...
  description: "Defence tech runs two clocks at once: warfighter outcomes and venture growth. Operating consultancy for defence tech builds the system that holds both.",
  keywords: ["operating consultancy for defence tech", "defence tech operating model", "defence tech startup operations", "ITAR compliance operations", "defence procurement timeline", "dual-use defence startup"],
  readTime: "10 min",
