export const frontmatter = {
  ...
  description: "Most consulting sells answers. Organisational consultancy reads how work runs and changes it without breaking what holds. What it means for People teams.",
