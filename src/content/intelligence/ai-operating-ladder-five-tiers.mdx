export const frontmatter = {
  ...
  description: "Most People and ops teams think they are two rungs higher than they are. The AI operating ladder scores AI maturity by function and names your exact next move.",
