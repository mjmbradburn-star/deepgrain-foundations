export const frontmatter = {
  ...
  description: "Strategy vs operating reality: a plan that assumes capability you don't have is a wish. How People and ops leaders read the gap and fund closing it.",
