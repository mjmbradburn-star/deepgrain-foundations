export const frontmatter = {
  ...
  description: "AI pilots stall on data, integration, governance and ownership, not the model. Why pilots die before production in People and ops teams, and the fix.",
