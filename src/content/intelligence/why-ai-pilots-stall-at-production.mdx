...
| Tool integration | A stable interface with an audit trail, not a personal API key | A workflow platform: SOC 2 and ISO 27001, roughly £20 per builder seat per month, self-hostable |
