export const frontmatter = {
  ...
  description: "Most climate ventures fail on the operating layer, not the science. Operating consultancy for climate ventures is holding two clocks at once: planet and fund.",
  keywords: ["operating consultancy for climate ventures", "climate tech operating", "why climate ventures fail", "climate venture operations", "MRV operating cadence", "climate startup pacing"],
  readTime: "11 min",
