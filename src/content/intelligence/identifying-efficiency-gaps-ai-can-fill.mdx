export const frontmatter = {
  ...
  description: "Most teams pick AI work by what is loudest. The gaps AI fills are repetitive, latency-bound, pattern-matching and owned. How People and ops teams find them.",
  keywords: [
...
<ComparePanel
  a={{ heading: "Ordinary automation earns it", items: [
    ...
    "A workflow tool, a schedule and a webhook cover most of it",
  ]}}
