export const frontmatter = {
  ...
  description:
    "Every AI maturity framework collapses to the same five tiers. For G&A and People leaders only one jump pays: pilot to integration. How to score it, and move it.",
  keywords: [
