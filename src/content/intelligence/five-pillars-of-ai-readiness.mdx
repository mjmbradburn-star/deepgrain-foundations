export const frontmatter = {
  ...
  description: "AI readiness is not a model problem. It is data, tools, agents, governance and cadence, in that order. The diagnostic People and ops teams can run this week.",
