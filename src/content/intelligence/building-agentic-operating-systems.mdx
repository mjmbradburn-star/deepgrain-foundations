export const frontmatter = {
  title: "Building agentic operating systems: a roadmap from prompts to production",
  slug: "building-agentic-operating-systems",
  category: "ai-operating-systems",
  description: "An agentic operating system is what you build when prompting stops being enough. This is the technical and organisational roadmap for moving from one-off LLM calls to interconnected agents that do real work, reliably, in production.",
  keywords: [
