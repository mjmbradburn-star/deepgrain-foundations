export const frontmatter = {
  ...
  description: "An agentic operating system is what you build when prompting stops being enough. A technical and organisational roadmap from one-off LLM calls to agents that do real work in production.",
  keywords: [
