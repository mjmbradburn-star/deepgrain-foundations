export const frontmatter = {
  ...
  description: "Most People and ops teams shop for an agent platform before they own one working agent. An agentic operating system is built the other way, one agent at a time.",
  keywords: [
