export const frontmatter = {
  ...
  description: "Founder-mode vs operator-mode is not a personality test. They are postures you switch between, and reading which one the moment wants is the executive job.",
