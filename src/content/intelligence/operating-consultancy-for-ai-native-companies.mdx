export const frontmatter = {
  ...
  description: "AI-native companies run on agents from day one, so the operating model has to put non-human operators on the org chart. Here is how you build it in.",
  keywords: ["AI-native companies", "AI-native operating model", "operating consultancy for AI-native companies", "agents on the org chart", "AI operating system for startups", "AI governance for agents"],
  readTime: "11 min",
