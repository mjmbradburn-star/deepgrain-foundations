export const frontmatter = {
  ...
  description: "Move from AI pilot to production when workflows repeat, controls are clear and shared infrastructure will stop teams rebuilding the same plumbing.",
