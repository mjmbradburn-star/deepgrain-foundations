export const frontmatter = {
  ...
  description: "Read, Craft, Scale is Deepgrain’s method: diagnose the operating reality, build the smallest useful intervention, then scale only what survives real work.",
