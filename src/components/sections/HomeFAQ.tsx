...
/**
 * Homepage FAQ. Five questions in the literal phrasings that show up in
 * GSC and Semrush around the AI operating system / Deepgrain category.
 * Mirrored exactly in FAQPage JSON-LD emitted from src/pages/Home.tsx via
 * PageMeta — keep this list and HOME_FAQ_LD in lockstep.
 */
