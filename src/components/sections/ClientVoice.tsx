...
export const ClientVoice = () => (
  <BarkSection contentClassName="container-grain max-w-4xl text-center section-pad">
    <ScrollReveal>
      ...
      <blockquote className="font-display italic text-2xl sm:text-3xl md:text-4xl lg:text-5xl leading-snug text-cream max-w-3xl mx-auto text-balance">
        &ldquo;Matt worked alongside our teams across People, Finance, and
        Legal, building real solutions to our challenges as we scaled at pace.
        Two months on, our champions are still building and extending
        automations with only minor support questions.&rdquo;
      </blockquote>
