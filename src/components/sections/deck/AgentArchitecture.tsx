    ...
    <div className="relative container-grain">
      ...
      <Reveal delay={200}>
        <div className="mt-16 grid md:grid-cols-[auto_1fr] gap-6 items-center">
          <div className="rounded-[1.4rem] bg-brass/[0.06] p-1.5 ring-1 ring-brass/20">
            <div className="rounded-[1.1rem] border border-brass/40 px-6 py-5 text-center shadow-[inset_0_1px_0_hsl(var(--cream)/0.12)]">
              <div className="font-display text-4xl text-brass leading-none">
                <AnimatedNumber value={5} countUp suffix=" to 1" />
              </div>
              <div className="text-cream/60 text-[10px] uppercase tracking-[0.25em] mt-2">
                Run by one
              </div>
            </div>
          </div>
