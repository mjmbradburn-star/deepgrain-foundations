  ...
  <>
    <section className="relative min-h-[90vh] flex items-end overflow-hidden">
      ...
      <div className="relative container-grain pb-20 md:pb-32 pt-40 max-w-5xl">
        <ScrollReveal>
          <Eyebrow className="text-cream/70 mb-6">About</Eyebrow>
          ...
          <div className="mt-10 max-w-xl text-cream/85 space-y-5 leading-relaxed">
            ...
            <p>
              At a certain point you've read enough grain to know what an
              organisation's is doing before most people have finished the
      ...
      <div className="container-grain max-w-3xl">
        <ScrollReveal>
          ...
          <div className="mt-10 space-y-5 text-body/85 leading-relaxed text-lg">
            <p>
              Deepgrain runs on AI agents designed specifically for this work.
      ...
      <div className="container-grain max-w-4xl">
        <ScrollReveal>
          ...
          <div className="space-y-4 text-cream/85 leading-relaxed text-lg">
            ...
            <p>Sectors: defence, climate, fintech, transit, health, legal, e-commerce.</p>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            {testimonials.map((t) => (
              <blockquote key={t.attribution}>
                <p className="font-display italic text-2xl text-cream leading-snug">“{t.quote}”</p>
